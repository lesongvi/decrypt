...
│   │   ├── decoder/
│   │   │   └── decoder_utils.go         # low-level type decoders
│   │   └── serializer/
│   │       └── bsii_serializer.go       # BSII -> SiiNunit text serializer
│   ├── model/
│   │   └── types.go                     # shared models, signatures, enums
│   └── stream/
│       └── stream_utils.go              # safe stream read helpers
└── tests/
    └── testdata/
        ├── game.sii
